...
#Verarbeitet werden die Dateinen mit der Erweiterung: 
#jpg, jpeg, png, jepg, webp, tiff, tif, gif, bmp, HEIC(optonal)
...
#
# V2.22 vom 6.12.2021
# 1.12.2021 *.gif und *.bmp Unterstützung eingebaut
# 3.13.2021 Abbruch wenn keine Datei oder keine gültige Bilddatei gewählt wird
# 4.12.2021 Auswahl von gemischten Dateien möglich -nur Bilddateien werden verarbeitet
# 4.12.2021 Verwendung als -action- und -script- Auswahl bei der Installation
Version="Bild verändern 2.22" #vom 6.12.2021
#----------------------------------------------------------------------------------------------
...
if [ -e "/home/$USER/.config/bildveraendern.style" ];then
    read BetriebArtIN breiteIn hoeheIn StyleIn < "/home/$USER/.config/bildveraendern.style"
else
    StyleIn=" "
fi
